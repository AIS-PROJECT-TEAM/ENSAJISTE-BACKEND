...
public class UserControler {
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(authorizationHeader.size() > 0){
            ...
            try {
                ...
                String access_token = jwtUtil.createAccessToken(email,request,user.getRoles().stream().map(Role::getName).collect(Collectors.toList()));
    ...
    public UserDetailsCustomResponse getUserDetails(HttpServletRequest request, HttpServletResponse response) throws IOException {
